...
func init() {
	android.RegisterModuleType("llvm10_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm10_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
