...
func init() {
	android.RegisterModuleType("llvm80_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm80_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
