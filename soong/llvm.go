...
func init() {
	android.RegisterModuleType("llvm50_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm50_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
