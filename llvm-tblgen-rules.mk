...
##########################################################
define transform-td-to-out50
$(if $(LOCAL_IS_HOST_MODULE),	\
	$(call transform-host-td-to-out50,$(1)),	\
	$(call transform-device-td-to-out50,$(1)))
endef
...
ifneq ($(strip $(TBLGEN_TABLES50)),)

generated_sources := $(call local-generated-sources-dir)
tblgen_gen_tables := $(addprefix $(generated_sources)/,$(TBLGEN_TABLES50))
...
#
ifeq ($(tblgen_source_dir),$(LLVM50_ROOT_PATH)/lib/Target/ARM/MCTargetDesc)
...
$(generated_sources)/%GenRegisterInfo.inc: $(tblgen_source_dir)/../%.td \
                                       $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50, register-info)
...
$(generated_sources)/%GenInstrInfo.inc: $(tblgen_source_dir)/../%.td \
                                    $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,instr-info)
...
$(generated_sources)/%GenSubtargetInfo.inc: $(tblgen_source_dir)/../%.td \
                                        $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,subtarget)
endif

ifeq ($(tblgen_source_dir),$(LLVM50_ROOT_PATH)/lib/Target/X86/MCTargetDesc)
$(generated_sources)/%GenRegisterInfo.inc: TBLGEN_LOCAL_MODULE := $(LOCAL_MODULE)
$(generated_sources)/%GenRegisterInfo.inc: $(tblgen_source_dir)/../%.td \
                                       $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50, register-info)
...
ifeq ($(tblgen_source_dir),$(LLVM50_ROOT_PATH)/lib/Target/Mips/MCTargetDesc)
$(generated_sources)/%GenRegisterInfo.inc: TBLGEN_LOCAL_MODULE := $(LOCAL_MODULE)
$(generated_sources)/%GenRegisterInfo.inc: $(tblgen_source_dir)/../%.td \
                                       $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50, register-info)
...
$(generated_sources)/%GenAsmWriter.inc: $(tblgen_source_dir)/%.td \
                                    $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,asm-writer)
endif
...
$(generated_sources)/%GenAsmWriter1.inc: $(tblgen_source_dir)/%.td \
                                     $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,asm-writer -asmwriternum=1)
endif
...
$(generated_sources)/%GenAsmMatcher.inc: $(tblgen_source_dir)/%.td \
                                     $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,asm-matcher)
endif
...
$(generated_sources)/%GenCodeEmitter.inc: $(tblgen_source_dir)/%.td \
                                      $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,emitter)
endif
...
$(generated_sources)/%GenMCPseudoLowering.inc: $(tblgen_source_dir)/%.td \
                                           $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,pseudo-lowering)
endif
...
$(generated_sources)/%GenDAGISel.inc: $(tblgen_source_dir)/%.td \
                                  $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,dag-isel)
endif
...
$(generated_sources)/%GenRegisterBank.inc: $(tblgen_source_dir)/%.td \
                                  $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,register-bank)
endif
...
$(generated_sources)/%GenDisassemblerTables.inc: $(tblgen_source_dir)/%.td \
                                             $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,disassembler)
endif
...
$(generated_sources)/%GenEDInfo.inc: $(tblgen_source_dir)/%.td \
                                 $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,enhanced-disassembly-info)
endif
...
$(generated_sources)/%GenFastISel.inc: $(tblgen_source_dir)/%.td \
                                   $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,fast-isel)
endif
...
$(generated_sources)/%GenGlobalISel.inc: $(tblgen_source_dir)/%.td \
                                   $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,global-isel)
endif
...
$(generated_sources)/%GenCallingConv.inc: $(tblgen_source_dir)/%.td \
                                      $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,callingconv)
endif
...
$(generated_sources)/%GenIntrinsics.inc: $(tblgen_source_dir)/%.td \
                                     $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,tgt-intrinsic)
endif
...
$(generated_sources)/%GenSystemOperands.inc: $(tblgen_source_dir)/%.td \
                                     $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,searchable-tables)
endif
...
$(generated_sources)/%GenDFAPacketizer.inc: $(tblgen_source_dir)/%.td \
                                     $(tblgen_td_deps) | $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,dfa-packetizer)
endif
...
$(generated_sources)/ARMGenDecoderTables.inc: $(tblgen_source_dir)/ARM.td \
                                          $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,arm-decoder)
endif
...
$(generated_sources)/Options.inc: $(tblgen_source_dir)/Options.td \
                                     $(tblgen_td_deps) \
                                     $(LLVM50_TBLGEN) \
                                     $(LLVM50_ROOT_PATH)/include/llvm/Option/OptParser.td
	$(call transform-td-to-out50,opt-parser-defs)
endif
...
$(generated_sources)/X86GenEVEX2VEXTables.inc: $(tblgen_source_dir)/X86.td \
                                          $(tblgen_td_deps) $(LLVM50_TBLGEN)
	$(call transform-td-to-out50,x86-EVEX2VEX-tables)
endif
