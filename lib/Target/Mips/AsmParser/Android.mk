...
mips_asm_parser_TBLGEN_TABLES50 := \
...
#===---------------------------------------------------------------===
# libLLVM50MipsAsmParser (host)
#===---------------------------------------------------------------===
include $(CLEAR_VARS)
include $(CLEAR_TBLGEN_VARS50)

LOCAL_MODULE:= libLLVM50MipsAsmParser
