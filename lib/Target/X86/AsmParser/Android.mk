...
x86_asm_parser_TBLGEN_TABLES50 :=	\
	X86GenAsmMatcher.inc	\
	X86GenInstrInfo.inc	\
	X86GenRegisterInfo.inc \
	X86GenSubtargetInfo.inc

x86_asm_parser_TBLGEN_TD_DIR50 := $(LOCAL_PATH)/..
...
LOCAL_MODULE:= libLLVM50X86AsmParser
LOCAL_MODULE_HOST_OS := darwin linux windows
LOCAL_SRC_FILES := $(x86_asm_parser_SRC_FILES)
LOCAL_C_INCLUDES += $(x86_asm_parser_C_INCLUDES)
TBLGEN_TABLES50 := $(x86_asm_parser_TBLGEN_TABLES50)
TBLGEN_TD_DIR50 := $(x86_asm_parser_TBLGEN_TD_DIR50)
