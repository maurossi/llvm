...
aarch64_asm_parser_TBLGEN_TABLES90 := \
...
aarch64_asm_parser_TBLGEN_TD_DIR90 := $(LOCAL_PATH)/..
...
LOCAL_MODULE:= libLLVM90AArch64AsmParser
LOCAL_MODULE_HOST_OS := darwin linux windows
LOCAL_SRC_FILES := $(aarch64_asm_parser_SRC_FILES)
LOCAL_C_INCLUDES += $(aarch64_asm_parser_C_INCLUDES)
TBLGEN_TABLES90 := $(aarch64_asm_parser_TBLGEN_TABLES90)
TBLGEN_TD_DIR90 := $(aarch64_asm_parser_TBLGEN_TD_DIR90)
