...
LOCAL_C_INCLUDES :=	\
	$(LLVM50_ROOT_PATH)	\
	$(LLVM50_ROOT_PATH)/include	\
	$(LLVM50_ROOT_PATH)/host/include	\
	$(LOCAL_C_INCLUDES)
...
ifeq (libLLVM50, $(filter libLLVM50,$(LOCAL_SHARED_LIBRARIES)$(LOCAL_SHARED_LIBRARIES_$(HOST_OS))))
# Skip building a 32-bit shared object if they are using libLLVM50.
...
###########################################################
define transform-host-td-to-out50
@mkdir -p $(dir $@)
@echo "Host TableGen: $(TBLGEN_LOCAL_MODULE) (gen-$(1)) <= $<"
$(hide) $(LLVM50_TBLGEN) \
	-I $(dir $<)	\
	-I $(LLVM50_ROOT_PATH)/include	\
	-I $(LLVM50_ROOT_PATH)/host/include	\
	-I $(LLVM50_ROOT_PATH)/lib/Target	\
