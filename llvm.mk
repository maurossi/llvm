...
LLVM_HOST_BUILD_MK := $(LLVM70_ROOT_PATH)/llvm-host-build.mk
LLVM_DEVICE_BUILD_MK := $(LLVM70_ROOT_PATH)/llvm-device-build.mk
...
LLVM_TBLGEN_RULES_MK := $(LLVM70_ROOT_PATH)/llvm-tblgen-rules.mk
